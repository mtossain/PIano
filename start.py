...
def MidiCallback(message, time_stamp):
   ...
   #     LoadSamples()
        ...
        globalvolume = float((1.0-velocity/127.0)*+1.5) # ranges from 0 to 3.0 now
...
p = pyaudio.PyAudio()
try:
    stream = p.open(format=pyaudio.paInt16, channels=2, rate=AudioRate, frames_per_buffer=AudioFramesPerBuffer, output=True,
...
if USE_CANDLE:
    ...
    def CandleCtrl():
        while True:
            ...
            if timesincestroke.total_seconds() < LightsTimeOut: # after x seconds switch off candles
